...
{
	use MABEL_WOF_LITE\Core\Models\Hidden_Option;
	use MABEL_WOF_LITE\Core\Models\Number_And_Choice_option;
	use MABEL_WOF_LITE\Core\Models\Option;
	use MABEL_WOF_LITE\Core\Models\Option_Section;
	use Exception;

	/**
	 * Register all options to show in admin screens.
	 * Class Options_Manager
	 * @package MABEL_WOF_LITE\Core
	 */
	class Options_Manager
	{
		/**
