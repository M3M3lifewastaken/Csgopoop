...
var WOFAdmin;!function(e){!function(t){var i=function(){function t(){this.getWheelsList(),this.initEditWheel(),this.initDeleteWheel(),this.initDuplicateWheel(),this.initToggleActivation()}return t.prototype.initToggleActivation=function(){jQuery(".wof-wheels-list").on("click",".wof-toggle-active",function(t){var i=jQuery(t.currentTarget);e.Api.Wheels.toggleActivation(i.data("wheel"),i.is(":checked")?1:0)})},t.prototype.getWheelsList=function(){var t=this;e.Api.Wheels.getWheels().then(function(e){if(t.wheels=e,0===t.wheels.length)jQuery(".wof-no-results").show();else{jQuery(".wof-no-results").hide();var i=window.doT.template(jQuery("#tpl-wof-wheels-list").html());jQuery(".wof-wheels-list").html(i({wheels:e}))}})},t.prototype.initDuplicateWheel=function(){var t=this,i=!1;jQuery(".wof-wheels-list").on("click",".wof-duplicate-wheel",function(l){if(l.preventDefault(),t.wheels.length>="brb".length)return alert("Please upgrade to pro to save more wheels.");if(!i){i=!0;var n=jQuery(l.currentTarget);n.css("opacity",.5),e.Api.Wheels.getWheel(n.data("wheel")).then(function(t){t.id=null,e.Api.Wheels.addWheel(t).then(function(){Core.Admin.Dispatcher.publish("wof-wheel:created"),i=!1,n.css("opacity",1)})})}})},t.prototype.initEditWheel=function(){jQuery(".wof-wheels-list").on("click",".wof-edit-wheel",function(t){t.preventDefault(),Core.Admin.Main.loading();var i=jQuery(t.currentTarget);e.Api.Wheels.getWheel(i.data("wheel")).then(function(e){Core.Admin.Dispatcher.publish("wof-wheel:edit",e)})})},t.prototype.initDeleteWheel=function(){jQuery(".wof-wheels-list").on("click",".wof-delete-wheel",function(t){t.preventDefault();var i=jQuery(t.currentTarget);e.Api.Wheels.deleteWheel(i.data("wheel")).then(function(){i.closest(".image-tile").hide("fast")})})},t}();t.WheelsListCtrl=i}(e.Controllers||(e.Controllers={}))}(WOFAdmin||(WOFAdmin={}));
