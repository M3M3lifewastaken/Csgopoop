...
Tags: optin, upsell, wheel, fortune, gamification
...
* [&raquo; Full-screen, completely custom demo (requires custom CSS)](http://demo.studiowombat.com/customized-wheel/)
* [&raquo; Documentation](https://studiowombat.com/kb-category/wp-optin-wheel/)

= PREMIUM FEATURES =

* Everything from the free version, plus:
* Create your own theme. Start with a predefined theme and fully edit to your liking.
...
* Supports Messenger opt-in via ChatFuel or Chatchamp.
...
Find out more about the [pro version here](https://studiowombat.com/plugin/wp-optin-wheel/?source=wof_wordpress)
